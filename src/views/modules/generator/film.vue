  ...
  <div class="mod-config">
    <el-form :inline="true"
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('generator:film:save')"
                   type="primary"
                   @click="addOrUpdateHandle()">新增</el-button>
        <el-button v-if="isAuth('generator:film:delete')"
                   type="danger"
                   @click="deleteHandle()"
    ...
    <el-table :data="dataList"
      ...
      <el-table-column prop="maxContentWidth"
                       header-align="center"
                       align="center"
                       label="最大内容宽度">
      </el-table-column>
      <el-table-column prop="contentHeight"
                       header-align="center"
                       align="center"
                       label="内容高度">
      </el-table-column>
...
<script>
import AddOrUpdate from './film-add-or-update'
export default {
  data () {
    return {
      dataForm: {
  ...
  methods: {
    ...
    deleteHandle (id) {
      ...
      this.$confirm(`确定对[id=${ids.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
        ...
        this.$http({
          url: this.$http.adornUrl('/generator/film/delete'),
          method: 'post',
